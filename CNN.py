# -*- coding: utf-8 -*-
"""
Created on Sun Jun 10 10:33:08 2018
...
mnist = input_data.read_data_sets('./mnist', one_hot=True) #they has been normalized to range (0,1)(它们已经被归一化到范围（0，1）)
text_x = mnist.test.images[:2000]
text_y = mnist.test.labels[:2000]
...
loss = tf.losses.sofmax_cross_entropy(onehot_labels = tf_y, logits = output)
